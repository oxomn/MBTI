...
const qnaList = [
  {
    q: '1. (눈) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 눈 주변이 떨리는 현상이 있어요.', type: [1, 2 ] },
      { answer: 'b. 눈이 건조하여 뻑뻑하고 가려움을 느껴요.', type: [0] },
      { answer: 'c. 해당 없지만 눈 건강이 걱정돼요.', type: [ 0 ] },
    ]
  },
  {
    q: '2. (피로) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 신경이 예민하고 잠을 이루기 힘들어요.', type: [2, 3] },
      { answer: 'b. 무기력하고 식욕이 없어요.', type: [3 ,2 ,1] },
      { answer: 'c. 자고 일어나도 피곤해요.', type: [3 , 6, 2, 1] },
    ]
  },
  {
    q: '3. (면역) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 스트레스가 매우 많아요.', type: [4] },
      { answer: 'b. 감기와 같은 감염성 질환에 자주 걸려요.', type: [4, 5, 7, 2 ] },
      { answer: 'c. 해당 없지만 면역력이 걱정돼요.', type: [6, 2, 5] }
    ]
  },
  {
    q: '4. (소화/장) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 변비가 있어요. ', type: [5 ] },
      { answer: 'b. 과민성 대장 증후군이에요.', type: [5, 8] },
      { answer: 'c. 소화가 잘 안 돼요.', type: [8] },
    ]
  },
  {
    q: '5. (피부) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 피부가 너무 건조해요.', type: [11] },
      { answer: 'b. 여드름성 피부예요.', type: [9 ]},
      { answer: 'c. 해당 없지만 피부 건강이 걱정돼요.', type: [6,4,7,5] },
    ]
  },

  {
    q: '6. (두뇌활동) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 기억력이 떨어지는 것 같아요.', type: [7, 3] },
      { answer: 'b. 두통이 자주 생겨요.', type: [2, 7 ] },
      { answer: 'c. 해당 없지만 두뇌활동 건강이 걱정돼요.', type: [7 ] },
    ]
  },
  {
    q: '7. (뼈/관절) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 평소 뼈가 약한 느낌이 있어요.', type: [1, 2 , 6 ] },
      { answer: 'b. 뼈가 부러져 본 적이 있어요.', type: [1, 4, 10 ] },
      { answer: 'c. 해당 없지만 뼈와 관절이 걱정돼요.', type: [1, 6] },
    ]
  },
  {
    q: '8. (모발) 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 머리카락이 잘 빠져요.', type: [1, 6] },
      { answer: 'b. 새치가 잘 생겨요.', type: [6, 7] },
      { answer: 'c. 해당 없지만 모발 건강이 걱정돼요.', type: [ 6 ] },
    ]
  },
  { 
    q: '9. (혈관/혈액순환) 해당하는 것을 고르세요.',
    a: [
      { answer: 'a. 손끝 또는 발끝이 자주 저려요.', type: [3, 2 ] },
      { answer: 'b. 충치가 생기고 잇몸이 자주 붓고 피가 나요.', type: [1, 2, 5] },
      { answer: 'c. 해당 없어요.', type: [7, 2] },
  ...
  },
  {
    q: '10. 해당하는 것을 선택하세요.',
    a: [
      { answer: 'a. 식사량을 줄이는 다이어트를 하고 있어요.', type: [6, 7, 5  ] },
      { answer: 'b. 입에 구내염이 자주 생겨요.', type: [ 3 ] },
      { answer: 'c. 해당 없어요.', type: [ 6 ] },
    ]
  },
  {
    q: '11. 가족이 갖고 있는 질환을 선택하세요. ',
    a: [
      { answer: 'a. 혈관(심근경색, 뇌출혈 등) 질환을 가지고 있어요.', type: [ 7,2 ] },
      { answer: 'b. 뼈/관절 질환(골다공증, 골감소증 등)을 가지고 있어요.', type: [1, 6] },
      { answer: 'c. 해당 없어요.', type: [7, 2, 7, 1] },
    ]
  },
  {
    q: '12. 해당하는 것을 선택하세요. ',
    a: [
      { answer: 'a. 목이 자주 건조해지거나 칼칼함이 느껴져요.', type: [ 6 ] },
      { answer: 'b. 시험이나 승진 등으로 집중력이 필요한 시기예요.', type: [7,2] },
      { answer: 'c. 해당 없어요.', type: [6, 7, 2] },
    ]
  }
]
